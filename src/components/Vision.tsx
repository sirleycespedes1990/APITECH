        ...
        <section id="inicio" className="py-20 bg-amber-100">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-2xl font-bold mb-4 text-amber-800">Nuestra Misión</h3>
                <p className="text-lg">
                  Proporcionar productos apícolas de la más alta calidad, promoviendo prácticas sostenibles y contribuyendo al bienestar de las comunidades y el medio ambiente. Nos esforzamos por ser líderes en innovación y excelencia en la industria apícola.
                </p>
              </div>
              <div>
